    ...
    try {
        ...
        if (form.type === "resident") {
            ...
            const {
                ...
                chairmanship,
                ...validated
            } = OfficialSchema.parse(form.data);
...
export async function DELETE(request: NextRequest) {
    try {
        ...
        if (id) {
            ...
            const resident = await prisma.resident.delete({ where: { id } });
            const jsDate = new Date();
            const date = dayjs(jsDate)
                .format("MM/DD/YYYYY HH:mm:ss")
                .split(" ");
            await prisma.logs.create({
                data: {
                    ...
                    data: {
                        ...
                        time: date[1],
                        category: "Resident",
                        message: "Successfully marked resident as deleted",
                    },
                },
            });
