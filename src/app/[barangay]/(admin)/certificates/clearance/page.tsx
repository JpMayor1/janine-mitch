                        ...
                        <div style={{ display: "flex" }}>
                            ...
                            <div style={{ flex: "70%", textAlign: "center" }}>
                                <div style={{ textAlign: "center" }}>
                                    ...
                                    <br />
                                    <b>
                                        (First Time Jobseekers Assistance Act-RA
                                        1128)
                                    </b>
                                </div>
                                ...
                                <br />
                                <div>
                                    This is to certify that Mr./Ms. {form.name},
                                    a resident of {form.barangay} for{" "}
                                    {form.count} years/months, is a qualified
                                    availee of RA 11261 or the First Time
                                    Jobseekers Act of 2019.
                                    <br />
                                    <br />
                                    I further certify that the holder/bearer was
                                    informed of his/her rights, including the
                                    duties and responsibilities accorded by RA
                                    11261 through the Oath of Undertaking he/she
                                    has signed and executed in the presence of
                                    our Barangay Official.
                                    <br />
                                    <br />
                                    Signed this {form.day} day of {form.month},{" "}
                                    {form.year} in the City/Municipality of{" "}
                                    {form.municipality}
                                    <br />
                                    <br />
                        ...
                        <div className="flex-auto">
                            <Input
                                ...
                                onChange={(ev) =>
                                    setForm((prev: any) => ({
                                        ...prev,
                                        validity: dayjs(ev.target.value).format(
                                            "MM/DD/YYYY"
                                        ),
                                    }))
                                }
